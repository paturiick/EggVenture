...
class ChangeFarmerProfilePicture {
  ...
  Future<void> changeFarmerProfilePicture(BuildContext context) async {
    try {
      ...
      DocumentReference userDocRef =
          _firestore.collection('farmer profile').doc(user.uid);
      DocumentSnapshot userDocSnapshot = await userDocRef.get();

      if (userDocSnapshot.exists) {
        // If the document exists, update the profile picture URL
        await userDocRef.update({
          'farmer_profile_picture': uploadedImageUrl,
        });
      } else {
